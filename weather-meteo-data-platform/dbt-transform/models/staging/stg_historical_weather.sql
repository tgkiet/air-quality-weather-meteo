...
WITH source_data AS (
    SELECT
        ...
        -- BUG-5/BUG-6 FIX: cột đã thêm vào bronze_historical_weather.
        -- NULL cho Hanoi CSV (CSV không có cột này).
        -- Có giá trị cho HCM backfill (backfill_history.py điền vào).
        location_name,
